...
atmos = Falc80()
atmos.vlos[:] = np.sin(np.linspace(0, 8*np.pi, atmos.Nspace)) * 20000
...
ctx = LwContext(atmos, spect, eqPops, initSol=InitialSolution.Lte, ngOptions=NgOptions(0,0,0), hprd=True)
