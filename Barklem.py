...
import numpy as np
if TYPE_CHECKING:
    from AtomicModel import AtomicLevel, AtomicLine, AtomicModel, determinate, CompositeLevelError
import string
...
class Barklem:
    ...
    def getActiveCrossSection(self, atom: 'AtomicModel', line: 'AtomicLine') -> Sequence[float]:
        ...
        if line.vdw.vals[0] < 20.0:
            ...
            E_Rydberg = Const.E_RYDBERG / (1.0 + Const.M_ELECTRON / (self.atomicTable[atom.name].weight * Const.AMU))
