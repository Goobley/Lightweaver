...
def chemical_equilibrium(atmos: Atmosphere, molecules: MolecularTable, atomicPops: LtePopulations) -> EquilibriumPopulations:
    ...
    for k in range(Nspace):
        ...
        while nIter < NmaxIter:
            ...
            # correction = newton_krylov(lambda x: (df@x - f)**2, n)
