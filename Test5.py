...
ctx = LwContext(atmos, spect, aSet, eqPops, get_global_atomic_table(), ngOptions=NgOptions(0,0,0), initSol=InitialSolution.Lte)
# # input()
# start = time.time()
